...
from .metrics.dvpq import Front3DLoader, MatterportLoader
...
class Front3DDPSEvaluator(CityscapesEvaluator):
    """
    ...
    def evaluate_dpq(self):
        ...
        for depth_thres in self.depth_thres:
            results = self.evaluator(1, self.LOADER.NUM_CLASSES, self.LOADER(pred_dir, self._metadata, depth_thres))
