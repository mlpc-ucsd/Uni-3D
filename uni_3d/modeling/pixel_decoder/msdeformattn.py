...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if depth_on:
            ...
            weight_init.c2_xavier_fill(self.depth_features)
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret["depth_on"] = cfg.MODEL.DEPTH_ON
        return ret
    ...
    def forward_features(self, features):
        ...
        if self.depth_on:
            return self.mask_features(out[-1]), self.depth_features(out[-1]), out[0], multi_scale_features
        else:
